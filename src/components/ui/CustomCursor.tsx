...
export default function CustomCursor() {
  ...
  return (
    <>
      <motion.div
        className="fixed top-0 left-0 w-8 h-8 border border-gold-500 rounded-full pointer-events-none z-[9999] hidden md:block"
        style={{
          x: cursorXSpring,
          y: cursorYSpring,
          translateX: "-50%",
          ...
          backgroundColor: isHovered ? "rgba(184, 145, 94, 0.1)" : "transparent",
